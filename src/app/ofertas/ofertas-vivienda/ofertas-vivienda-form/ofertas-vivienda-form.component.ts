...
@Component({
  selector: 'app-ofertas-vivienda-form',
  templateUrl: './ofertas-vivienda-form.component.html',
  styleUrls: ['./ofertas-vivienda-form.component.css']
})
export class OfertasViviendaFormComponent implements OnInit {
